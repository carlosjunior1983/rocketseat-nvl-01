...
const CreatePoint = () => {
    ...
    const [selectedUf, setSelectedUf] = useState('00');
                    ...
                    <div className="field-group">
                        <div className="field">
                            ...
                            <select name="uf" id="uf" value={selectedUf} onChange={handleSelectUf}>
                                <option id="00" value="0">Selecione uma UF</option>
                                {ufs.map( uf => (
